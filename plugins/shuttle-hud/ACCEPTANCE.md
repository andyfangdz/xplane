...
## Release 143 native validation and landing baseline

Release 143 validates this project’s Rust HUD and shared repository SDK
infrastructure with the established landing equations, original vector lettering,
symbology, optics, aircraft geometry and control laws.

The Rust workspace has 37 passing tests and one existing ignored local-scenery database
test. Clippy with warnings denied and the release build pass. Project regression
...
limit; release 142's comparable run reached 0.755323 m. No physics, validation pilot,
threshold or landing calibration was changed to obtain a passing result.
...
Read the [native validation report](../../docs/shuttle-hud/rust-port/README.md),
[native gallery](../../docs/shuttle-hud/rust-port/GALLERY.md) and
[validation criteria](../../docs/shuttle-hud/rust-port/ACCEPTANCE.md) for the
