...
with XPlaneApi(port=8144,timeout=8) as a:
 ...
 try:
  ...
  for _ in range(3):
   ...
   s=snap(a,'verified-140-ground-cycle-'+str(len(cycle)+1),'observed stopped state; manual declutter command')
  ...
  init(a,'verified-140-fade-fixed',height=18100,along=-18000,pitch=-5,gamma=-10)
  ...
  s=snap(a,'verified-140-fade-start');assert s['fsim_hud/display_phase']==2 and s['fsim_hud/velocity_vector_blend']<.2
  out['fade_start']=s
  a.set_dataref('sim/operation/override/override_planepath',[1]+[0]*19)
  advance(a,2.4);out['fade_mid']=snap(a,'verified-140-fade-mid')
  advance(a,2.8);s=snap(a,'verified-140-fade-complete');assert s['fsim_hud/velocity_vector_blend']==1;out['fade_end']=s
  ...
  out['replay']=snap(a,'verified-140-replay')
  ...
  out['replay_exit']=snap(a,'verified-140-replay-exit')
  init(a,'verified-140-optical-center',height=3300,along=-5050,pitch=-10)
